...
3. Vous pouvez effectuer tout ce processus via votre navigateur sans connaître Git. Cependant, apprendre à utiliser GitHub Desktop vous permettra de tester vos modifications localement avant de les publier pour que le monde entier puisse les voir.
...
8. Assurez-vous d'avoir le fichier ".nojekyll" ; il s'agit d'un fichier vide nécessaire pour héberger un site web sur Github, sans quoi le SRD ne s'affichera pas correctement. *(Indique aux GitHub Pages de ne pas traiter les fichiers publiés via Jekyll).*
...
Ceci est votre menu, le volet de navigation situé sur le côté gauche du site web. Une fois que vous avez ajouté un fichier markdown à votre dépôt, vous devez y ajouter le fichier pour que son contenu soit inclus. Suivez la mise en forme existante.
