...
3. Vous pouvez effectuer tout ce processus via le navigateur sans connaître git. Bien que l'apprentissage de GitHub Desktop vous permette de tester les modifications localement avant de les déployer en direct pour que le monde entier puisse les voir.
...
Cela prendra de 5 à 30 secondes pour copier le modèle, puis vous aurez votre propre copie.
...
C'est votre menu, le volet de navigation sur le côté gauche du site web. Une fois que vous avez ajouté un fichier markdown à votre dépôt, vous devez ajouter le fichier ici pour que son contenu soit inclus. Suivez la mise en forme existante.
